<div class="col__right__container pageNhapDiem">
    ...
    <div class="col__right__container__table">
        ...
        <div class="col__right__container__table__from">
            ...
            <div class="col__right__container__table__from__item">
                <label>Lớp:</label><br>
                <select onchange="chonLopND()" id="selectLopND">
            ...
            <div class="col__right__container__table__from__item">
                ...
                <input type="text" value="2019-2023" id="khoahocNhapDiem">
            </div>
        ...
        <table onchange="showValue()" style="width:100%">
            ...
            <form>
                ...
                <tr>
                    <td style="font-weight: bold; width:5%; text-align: center;"></td>
                    <td
                        style="text-align: center; font-size: 20px; font-weight: bold; max-width: 500px; height:auto; word-wrap:break-word; padding: 10px;">
                        Tổng cộng
                    </td>
                    <td style="font-weight: bold; font-size: 20px; width:10%; text-align: center;">100</td>
                    <td style="width:10%; text-align: center;">
                        <input style="font-weight: bold; font-size: 20px;" id="tongcong" type="text" readonly>
                    </td>
                </tr>
